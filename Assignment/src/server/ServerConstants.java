...
public class ServerConstants {
	...
	public static final int DRAW_BROADCAST_RECT = 6;
	public static final int DRAW_BROADCAST_OVAL = 7;
	public static final int DRAW_BROADCAST_LINE_START = 8;
	public static final int DRAW_BROADCAST_LINE_END = 9;
	public static final int DRAW_SAVE = 10;
}
